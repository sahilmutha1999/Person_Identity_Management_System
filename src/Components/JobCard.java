...
public class JobCard extends javax.swing.JPanel {
    ...
    public void setData(Model_Job_Card data) {
        lblCourseImg.setIcon(data.getEmployerImage());
        lblSubject.setText(data.getEmployerName());
        lblCourseName.setText(data.getJobRole());
        lblCoursePrice.setText(Double.toString(data.getPay()));
    }
    ...
    private void initComponents() {
        ...
        btnView.setText("View Job Details");
