...
public class EmployerSignUp extends javax.swing.JPanel {
    ...
    Business business;
    public EmployerSignUp(JPanel rightProcessingContainer,
    ...
    private void initComponents() {
        ...
        jLabel21.setText("Employer Sign Up");
        ...
        kGradientPanel3Layout.setVerticalGroup(
            ...
            .addGroup(kGradientPanel3Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cbIndustry, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        if (!isValidEmail(email)) {
            JOptionPane.showMessageDialog(null, "Invalid email address", "Error Message", JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        String name = txtName.getText();
        String industry = (String)cbIndustry.getSelectedItem();
        String country = (String)cbCountry.getSelectedItem();
        
        EmployerOrganization eo = new EmployerOrganization(name, industry, country);
        ...
        eo.getPersonDirectory().getPersonList().add(person);
        eo.getUserAccountDirectory().getUserAccountList().add(userAccount);
        
        JOptionPane.showMessageDialog(null, "New Employer Account Created !!");
