 ...
 * @author sahil
 */
public class RecruiterLeftPanel extends javax.swing.JPanel {
    ...
    public RecruiterLeftPanel(JPanel rightProcessingContainer, 
    ...
    private void setname() {
        ...
        for(UserAccount ua: employerOrganization.getUserAccountDirectory().getUserAccountList()){
            if (ua.equals(userAccount)){
                lblname.setText(ua.getAssociatedPerson().getName());
            }
        }
    }
    ...
    private void initComponents() {
        ...
        btnManageProfile.setText("Manage Incoming Applications");
    ...
    private void btnManageProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageProfileActionPerformed
        // TODO add your handling code here:
        ManageIncomingApplications jobmanagement = new ManageIncomingApplications(
                employerOrganization, userAccount, business, rightProcessingContainer);
        rightProcessingContainer.add("ManageIncomingApplications",jobmanagement);
