...
//    JPanel mainWorkArea;
    ...
    public StudentLogin(JPanel rightProcessingContainer,
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        for (Organization organization : 
            ...
            if (userAccount != null && ao.getSupportedRole().contains(
                    userAccount.getRole())){

                ao = (ApplicantOrganization) organization;
                
                for (Applicant a: ao.getApplicantDirectory().getApplicantList()) {
                    if (a.getPerson().equals(userAccount.getAssociatedPerson())) 
                        applicant = a;
                }
                
                StudentLeftPanel studentleftpanel = new StudentLeftPanel(
                        rightProcessingContainer, leftProcessingContainer, 
                        userAccount, organization, business, applicant);
                
                leftProcessingContainer.add("StudentLeftPanel", studentleftpanel);
                CardLayout layout = (CardLayout) leftProcessingContainer.getLayout();
                layout.next(leftProcessingContainer);
                
                StudentDashboard ucl = new StudentDashboard(userAccount);
    ...
    private void btnSignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignupActionPerformed
        // TODO add your handling code here:
        StudentSignUp ss = new StudentSignUp(rightProcessingContainer, leftProcessingContainer, business);
        rightProcessingContainer.add("StudentSignUp", ss);
