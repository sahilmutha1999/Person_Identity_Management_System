...
import ui.CertificationAuthority.CertificationLeftPanel;
import ui.Student.*;
...
public class PublicationLogin extends javax.swing.JPanel {
    ...
    public PublicationLogin(JPanel rightProcessingContainer,
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Publication Authority Login");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        PublicationOrganization po = new PublicationOrganization();
        ...
        for(Organization organization : business.getOrganizationDirectory()
            ...
            if (userAccount != null && po.getSupportedRole().contains(
                    userAccount.getRole())){
                publicationOrganization = (PublicationOrganization) organization;
                
                PublicationLeftPanel leftpanel = new PublicationLeftPanel(
                    rightProcessingContainer, leftProcessingContainer, business, 
                        publicationOrganization);
                leftProcessingContainer.add("PublicationLeftPanel", leftpanel);
                CardLayout layout = (CardLayout) leftProcessingContainer.getLayout();
                layout.next(leftProcessingContainer);

                ManageIncomingRequests managejobapp = new ManageIncomingRequests(
                        publicationOrganization);
                rightProcessingContainer.add("ManageIncomingRequests", managejobapp);
    ...
    private void btnSignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignupActionPerformed
        // TODO add your handling code here:
        PublicationSignUp publicationsignup = new PublicationSignUp(
                rightProcessingContainer, leftProcessingContainer, business);
        rightProcessingContainer.add("PublicationSignUp", publicationsignup);
