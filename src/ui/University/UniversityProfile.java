 ...
 * @author sahil
 */
public class UniversityProfile extends javax.swing.JPanel {
    ...
    public UniversityProfile(UniversityOrganization universityOrganization,
            UserAccount userAccount) {
        initComponents();
    ...
    private void populatedata() {
        txtName.setText(universityOrganization.getUniversity().getName());
        txtEmail.setText(userAccount.getAssociatedPerson().getEmailAddress());
        cbCountry.setSelectedItem(universityOrganization.getUniversity().getCountry());
